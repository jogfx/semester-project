...
# Connect to your SQL database (replace 'sqlite:///your_database.db' with your actual database connection string)
...
for title, published_at, name, content, url, url_to_image, id_ in zip(preprocessed_data['title'], preprocessed_data['publishedAt'], preprocessed_data['Name'], preprocessed_data['Content'], preprocessed_data['url'], preprocessed_data['urlToImage'], preprocessed_data['ID']):
